...
export default function Page() {
  ...
  const [loaderAfterUsername, setLoaderAfterUsername] = useState(false);
  const [loaderAfterPassword, setLoaderAfterPassword] = useState(false);
  const {
    register,
    handleSubmit,
    setValue,
    ...
    <div className="flex font-[family-name:var(--font-intervariable)]">
      <div className="w-full">
        <div className="p-5 md:p-11 ">
            ...
            {!userUpdatingUsername && (
              <div className="container md:w-5/6 mx-auto flex flex-col gap-10 mt-20">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <button
                    type="submit"
                    className="w-full h-14 flex items-center justify-center rounded-full bg-[rgb(129,41,217)] hover:bg-[rgb(93,24,162)] py-3 font-bold text-white disabled:bg-[#e0e2d9] disabled:text-[#a8aaa2]"
                    disabled={errors.email || errors.password}
                  >
                    {loaderAfterPassword ? (
                      <img className="h-full" src="/loader.gif" />
                    ) : userUpdatingPassword ? (
                      "Create account"
                    ) : (
                      "Continue"
          ...
          <div className="flex flex-col gap-4 container md:w-5/6 mx-auto mt-10">
            ...
            <button
              ...
              onClick={async () => {
                setLoaderAfterPassword(true);
                await signIn("google");
                setLoaderAfterPassword(false);
              }}
            >
              <svg
                width="24"
